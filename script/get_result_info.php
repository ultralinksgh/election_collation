...
<div class="row mt-2">
        ...
        <form id="formPresident" autocomplete="off">
            ...
            <div class="col-sm-12 p-1 g-1">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="votes[<?php echo $rec['name']; ?>]" class="form-control" onkeypress="return isNumber(event);" />
                    </div>
                </div>
            </div>
            <?php } ?>
            <button type="submit" class="btn btn-primary offset-3 mt-3 btn_pres_save">Save Results</button>
        </form>
    </div>
    ...
    <div class="col-sm-6 mt-3">
        ...
        <form id="formParliament" autocomplete="off">
            ...
            <?php } ?>
            <button class="btn btn-secondary offset-3 mt-3 btn_par_save">Save Results</button>
        </form>
    </div>
    <br>
    <?php }else{
        echo '<div class="col-sm-12 mt-4 text-danger">No Results Found</div>';
    } ?>
</div>
